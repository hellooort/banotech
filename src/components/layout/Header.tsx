          ...
          {openMega === 'company' && (
            <div className="flex gap-6">
              {[
                ...
                { icon: ShieldCheck, label: t.navSub.productionLine, desc: locale === 'ko' ? '국내 생산시설 안내' : 'Domestic production facilities', href: '/about/production-line' },
          ...
          {openMega === 'contactUs' && (
            <div className="flex gap-4">
              {[
                ...
                { icon: Mail, label: t.mega.emailInquiry, desc: 'vanovano@naver.com', href: 'https://mail.google.com/mail/?view=cm&fs=1&to=vanovano@naver.com', external: true },
              ].map((item) => {
                const className = cn(
                  'group flex flex-1 items-start gap-3 rounded-xl border border-transparent p-4 transition-all',
                  isHome ? 'hover:border-brand/30 hover:bg-brand-light/60' : 'hover:border-white/20 hover:bg-white/10'
              ...
              <div key={item.key} className="border-b border-border last:border-0">
                ...
                {mobileSection === item.key && item.key === 'contactUs' && (
                  <div className="pb-2 pl-4">
                    ...
                    <a
                      href="https://mail.google.com/mail/?view=cm&fs=1&to=vanovano@naver.com"
                      target="_blank"
